...
const CsrEdit = () => {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      <p className="text-center font-bold mt-2 p-2 text-gray-800 border border-black bg-gray-400">
        Customer Service Report
      </p>
      <div className="border border-black p-4 sm:p-6 bg-gray-200 my-6">
        ...
        <p className="text-xs sm:text-sm text-gray-900">Phone1 - 9650016127</p>
        <p className="text-xs sm:text-sm text-gray-900">Phone2 - 9821981112</p>
        <p className="text-xs sm:text-sm text-gray-900">
          Support@pesonline.co.in account@pesonline.co.in
        </p>
        <p className="text-xs sm:text-sm text-gray-900">Faridabad-Haryana-121004</p>
      </div>
      <div className="my-6 px-4 sm:px-6">
        <div className="animate_animated animate_backInDown">
          <div className="grid gap-4 sm:gap-6 mb-6 grid-cols-1 sm:grid-cols-2">
            <div>
              <label
                htmlFor="Customer_Name"
                className="block mb-1 text-xs sm:text-sm font-medium text-gray-900 dark:text-white"
              >
                Customer Name:
              </label>
              <input
                ...
                name="Customer_Name"
                id="Customer_Name"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 sm:p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Customer Name"
              />
            </div>
            <div>
          ...
          <div className="mb-4">
            <label
              htmlFor="ProblemIdentifiedByServiceEngineer"
              className="block mb-1 text-xs sm:text-sm font-medium text-gray-900 dark:text-white"
            >
              Problem Identified By Service Engineer:
            </label>
            <textarea
              ...
              name="ProblemIdentifiedByServiceEngineer"
              rows={4}
              id="ProblemIdentifiedByServiceEngineer"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 sm:p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Detail Problem Reported"
            />
          </div>
          <div className="mb-4">
            <label
              htmlFor="ProblemRectifiedByServiceEngineer"
              className="block mb-1 text-xs sm:text-sm font-medium text-gray-900 dark:text-white"
            >
            ...
            <textarea
              ...
              name="ProblemRectifiedByServiceEngineer"
              rows={4}
              id="ProblemRectifiedByServiceEngineer"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 sm:p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Reported By"
            />
          </div>
          ...
          <div className="mb-4">
            <label
              htmlFor="AttendedEngineerRemarks"
              className="block mb-1 text-xs sm:text-sm font-medium text-gray-900 dark:text-white"
            >
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={4}
              id="AttendedEngineerRemarks"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-xs sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 sm:p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder-gray-300 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              placeholder="Attended Engineer Remarks"
            />
          </div>
          <button
            type="submit"
            onClick={handleOnSubmit}
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs sm:text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Submit
          </button>
        </div>
