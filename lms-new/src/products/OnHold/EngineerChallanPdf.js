        ...
        <div className="w-fit mx-auto">
          <div className="flex flex-col aspect-[1/1.4] w-[600px] border-[2px] border-black ">
            ...
            <div className="flex px-5  justify-between">
              <p className="text-[11px] font-sans font-semibold">
                Total Product : {data?.challanDetails?.length}
              </p>
        
           
                       <p className="text-[11px] font-sans font-semibold">
             Site Name : {data?.challanDetails[0]?.issueToSite}
              </p>
              <p></p>
              <p></p>
              <p></p>
...
//         <div className="w-full max-w-[595px] min-h-[842px] mx-auto border-2 border-black flex flex-col">
//           {/* Header Section */}
...
//           {/* Table - Fixed height for 20 rows with scroll */}
//           <div className="flex-1 min-h-[720px] max-h-[720px] overflow-y-auto">
...
//                 {data?.challanDetails.map((item, key) => (
//                   <tr key={key} className="text-center">
//                     <td className="border border-black  sm:px-2 ">{item.productSrNo}</td>
//                     <td className="border border-black  sm:px-2 ">{item.otherProductSrNo ?? "-"}</td>
//                     <td className="border border-black  sm:px-2 ">{item.productType}</td>
//                     <td className="border border-black  sm:px-2 ">{item.outTime ?? "-"}</td>
//                     <td className="border border-black  sm:px-2 ">{item.EngineerRecievingTime ?? "-"}</td>
//                     <td className="border border-black  sm:px-2 ">{item.EngineerHandoverTime ?? "-"}</td>
//                     <td className="border border-black  sm:px-2 ">{item.inTime ?? "-"}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
