...
import ProductionChallanTable from "./ProductionchallanTable";
...
const ChallanHistory = () => {
  ...
  const [challanUrl,setChallanUrl]=useState('downloadchallanpdf');
  const [type ,setType]=useState("internalReturnableChallan")
  //   useEffect(() => {
  ...
  const searchChallan = async () => {
    ...
    const url = qs.stringifyUrl({
      ...
      query: {
        ...
        challanType: "internal returnable challan",
