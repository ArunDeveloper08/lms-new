...
const MechanicalToolChallanPdf = () => {
  const { challanNumber } = useParams();
  const { search } = useLocation();
  const [data, setData] = useState({});
  const [loading, setLoading] = useState(false);
  ...
  return loading ? (
    ...
    <>
      ...
      <div className="w-fit mx-auto">
        <PDFExport ref={pdfExportComponent}>
          <div className="flex flex-col aspect-[1/1.4] w-[600px] border-[3px] border-black ">
            <div className="w-full text-center mx-auto mt-2 mb-2">
              ...
              <p className="text-[13px] font-sans font-bold border-b-[3px] border-black">
                Original / Duplicate / Triplicate
              </p>
            ...
            <table className="table-for-pdf">
              <thead>
                <tr>
                  ...
                  <th className="">Accepted By Mech..</th>
                  <th className="">Send By Mech.</th>
...
export default MechanicalToolChallanPdf;
